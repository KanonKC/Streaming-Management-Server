...
import { showImage, ShowImageOptions } from "../modules/ShowImage"
...
export async function advancedShowImageController(request: AdvancedShowImage, reply: FastifyReply) {
    const { body } = request
